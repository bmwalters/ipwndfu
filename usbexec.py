...
configs = [
  ExecConfig((b'SecureROM for s5l8940xsi, Copyright 2010, Apple Inc.',   b'RELEASE',     b'iBoot-838.3'),          aes_crypto_cmd=0xfeedface),
  ExecConfig((b'SecureROM for s5l8942xsi, Copyright 2011, Apple Inc.',   b'RELEASE',     b'rom'),          aes_crypto_cmd=0xfeedface),
  ExecConfig((b'SecureROM for s5l8945xsi, Copyright 2010, Apple Inc.',   b'RELEASE',     b'iBoot-1062.2'),          aes_crypto_cmd=0xfeedface),
